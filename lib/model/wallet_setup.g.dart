...
class _$WalletSetup extends WalletSetup {
  ...
  _$WalletSetup._(
      ...
      this.errors})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(mnemonic, 'WalletSetup', 'mnemonic');
    ...
    BuiltValueNullFieldError.checkNotNull(errors, 'WalletSetup', 'errors');
  }
