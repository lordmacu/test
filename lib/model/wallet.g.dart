...
class _$Wallet extends Wallet {
  ...
  _$Wallet._(
      ...
      this.errors})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(address, 'Wallet', 'address');
    BuiltValueNullFieldError.checkNotNull(privateKey, 'Wallet', 'privateKey');
    ...
    BuiltValueNullFieldError.checkNotNull(errors, 'Wallet', 'errors');
  }
